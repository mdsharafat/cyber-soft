                                                ...
                                                <tbody>
                                                    @foreach($contactMessages as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{ $item->lon }}</td>
                                                            <td>
                                                                <a href="{{ url('admin/archive-message/' . $item->id) }}" title="Activate"><button class="btn btn-teal teal-icon-notika waves-effect"><i class="notika-icon notika-checked"></i></button></a>
                                                                <form method="POST" action="{{ url('/delete-contact-message' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                                    {{ method_field('DELETE') }}
                                                                    {{ csrf_field() }}
